...
export function Settings() {
  ...
  // Removed all unsupported provider config components

  // All other provider config components removed - only CustomAPI is supported

  // All provider-specific config components removed - only CustomAPI supported
